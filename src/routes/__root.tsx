...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      { name: "theme-color", content: "#ECE8DF" },
      ...
      { name: "msapplication-TileColor", content: "#ECE8DF" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,400;9..144,500;9..144,560;9..144,600&family=Manrope:wght@400;500;600;700&display=swap",
      },
    ],
  }),
  component: () => (
